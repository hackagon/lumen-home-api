...
const clientKafkaConfig: IClientKafkaConfig[] = [
  {
    name: EMicroservice.AGGREGATION_SSO_SERVICE,
    clientId: EMicroservice.AGGREGATION_SSO_SERVICE,
    groupId: EKafkaGroup.SSO_GROUP,
  },
  {
    name: EMicroservice.AGGREGATION_BOOKING_SERVICE,
    clientId: EMicroservice.AGGREGATION_BOOKING_SERVICE,
    groupId: EKafkaGroup.AGGREGATION_GROUP,
  },
];
